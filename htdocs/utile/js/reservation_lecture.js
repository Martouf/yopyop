  ...
  $(function() {
	...
	function Application(){
		...
		this.addComment = function(e){
			...
			$.post(url,{'nom':nomCommentaire,'description':descriptionCommentaire,'id_auteur':idAuteurCommentaire,'mail':mailCommentaire,'url':urlCommentaire,'id_element':idReservation,'table_element':'reservation'},app.refreshPage);
