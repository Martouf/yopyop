/*******************************************************************************************
 * Nom du fichier		: transaction.js
 * Date					: 24 juillet 2011
 * Auteur				: Mathieu Despont
 * Adresse E-mail		: mathieu (at) ecodev.ch
 * But de ce fichier	: Fournir la partie javascript de manipulation de transactions
 *******************************************************************************************
 * 
 *
 */
...
(function($) { 
  $(function() {
	...
	$(document).ready(function(){
		...
		if (document.getElementById("listeTransactions") != null) {
			 $("#listeTransactions").tablesorter(); 
			
			// charge le filtre du tableau
			var theTable = $('#listeTransactions');
