...
if ($action=='get') {
	...
	if (!empty($idFichier)) {
		...
		$additionalHeader = "
			...
			<script type=\"text/javascript\" src=\"http://".$serveur."/utile/js/fichier.js\"></script>";	
...
///////////////
	...
	if ($_SESSION['id_personne'] != '1') {
		...
		$additionalHeader = "
			...
			<script type=\"text/javascript\" src=\"http://".$serveur."/utile/js/interface.js\"></script>
			<script type=\"text/javascript\" src=\"http://".$serveur."/utile/js/jquery.bgiframe.js\"></script>
			<script type=\"text/javascript\" src=\"http://".$serveur."/utile/js/jquery.autocomplete.js\"></script>";  //		<script type=\"text/javascript\" src=\"http://".$serveur."/utile/js/fichier.js\"></script>	
		$smarty->assign('additionalHeader',$additionalHeader);
...
///////////////
	...
	if ($droitModification) {
		...
		$additionalHeader = "
			...
			<script type=\"text/javascript\">startRichEditor();</script>";	//			<script type=\"text/javascript\" src=\"http://".$serveur."/utile/js/fichier.js\"></script>
		$smarty->assign('additionalHeader',$additionalHeader);
