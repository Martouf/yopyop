...
<div id="blocCentre">
	<div>
		...
		&nbsp;&nbsp;&nbsp;<a href="//<!--{$server_name}-->/lieu/?new" id="boutonNewLieu"><img src="http://<!--{$server_name}-->/utile/img/add.png" alt="add" /> ajouter un lieu</a>
		</form>
	</div>
	<br />
	...
	<table id="listeLieux" class="tablesorter" cellpadding="0" cellspacing="0" >
		...
		<tbody>
			...
			<tr>
				<td><a href="//<!--{$server_name}-->/lieu/<!--{$aLieu.id_lieu}-->-<!--{$aLieu.nomSimplifie}-->.html?modify"><!--{$aLieu.nom}--></a></td>
				<td><!--{$aLieu.commune}--></td>
				<td><!--{$aLieu.rue}--></td>
