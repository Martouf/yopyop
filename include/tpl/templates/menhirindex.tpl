...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="http://<!--{$server_name}-->/utile/css/menhir.css" media="screen" />
		<link type="text/css" rel="stylesheet" href="http://<!--{$server_name}-->/utile/css/menhir_print.css" media="print" />
