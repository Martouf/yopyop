...
<form action="personne.html?add" method="post" accept-charset="utf-8">
			...
			<div id="blocEditionPersonne" >
				...
				<p><label>Naissance</label> <input type="text" name="date_naissance" value="1981-07-12 00:00:00" id="inputNaissance"></input> <span class="info">Selon le format: AAAA-MM-JJ  00:00:00  (ouais.. c'est un peu brut pour le moment :P)</span></p></p>
