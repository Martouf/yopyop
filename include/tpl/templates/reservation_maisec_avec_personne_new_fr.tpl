	<div id="reservation" >
		...
		<h2>Formulaire de demande de réservation pour <!--{$objetAReserver.nom}--></h2>
	...
	<p><a href="#" id="createReservation"><img src="/utile/img/save.png" alt="save" /> envoyer une demande de réservation</a></p>
